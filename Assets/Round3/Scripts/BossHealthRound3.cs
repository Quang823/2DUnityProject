...
public class BossHealthRound3 : MonoBehaviour
{
    [Header("UI Elements")]
    ...
    private IEnumerator HandleBossDeath()
    {
        ...
        if (gems.Length > 0)
        {
            ...
            droppedGem.GetComponent<GemPickupRound3>().bossHealth = this;
    ...
    public void OnGemCollected()
    {
        ...
        {
            Debug.LogError("DoorController reference is NULL! Please assign it in the Inspector.");
        }
    }
